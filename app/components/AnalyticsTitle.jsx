...
import { BlockStack, Box, Button, Card, Icon, InlineGrid, InlineStack, Text, Tooltip } from '@shopify/polaris';
import {
    AlertCircleIcon, ChevronDownIcon, ArrowDownIcon, ArrowUpIcon
    ...
    return (
        <Box className="AnalyticsTitle_Wrap" >
            <InlineStack align='space-between' blockAlign="center" wrap={true}>
                <Box>
                    <Text variant="heading2xl" as="h2" fontWeight='600'>Analytics</Text>
                </Box>
